...
public class Cargo_Buscar extends JP_Modelo {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(aplibodega.ApliBodegaApp.class).getContext().getResourceMap(Cargo_Buscar.class);
    ...
    private void JtCargoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JtCargoMouseClicked
        ...
        if(this.getRefDep() instanceof Empleado_Administrar)//para ver quien fue quien lo llamo
        {
            ((Empleado_Administrar)this.getRefDep()).ObtenerCargo(ccodigo);
        }
        this.cerrarPadre();
