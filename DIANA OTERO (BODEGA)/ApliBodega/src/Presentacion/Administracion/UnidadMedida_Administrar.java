...
public class UnidadMedida_Administrar extends JP_Modelo {
    ...
    public UnidadMedida_Administrar() {
        initComponents();
  ...
  public void Formato_tabla(){
        this.JtUnidadMedida.getColumnModel().getColumn(0).setPreferredWidth(50);
        this.JtUnidadMedida.getColumnModel().getColumn(1).setPreferredWidth(300);
  }
  ...
  public void RegistrarUnidadMedida()
  {
        ...
        if(vCodigo.isEmpty() || vNombre.isEmpty()){
            ...
            int respuesta=JOptionPane.showConfirmDialog(null,"¿Seguro de regístrar datos de unidad de medida?","Pregunta",JOptionPane.YES_NO_OPTION);
            if(respuesta==JOptionPane.OK_OPTION)
            {
                UnidadMedida objUnidadMedida=null;
                try {
                    objUnidadMedida=new UnidadMedida();
                    objUnidadMedida.setCodigo_uni(this.txtCodigo.getText().trim());
                    objUnidadMedida.setNombre_uni(this.txtNombre.getText().trim());
                    objUnidadMedida.setDescripcion_uni(this.txtaDescripcion.getText().trim());

                    if(unidad.unidadMedida_registrar(objUnidadMedida)==true){
  ...
  public void EditarUnidadMedida()
    {
        ...
        if(vCodigo.isEmpty() || vNombre.isEmpty()){
            ...
            int respuesta=JOptionPane.showConfirmDialog(null,"¿Seguro de editar datos de unidad de medida?","Pregunta",JOptionPane.YES_NO_OPTION);
            if(respuesta==JOptionPane.OK_OPTION)
            {
                UnidadMedida objUnidadMedida=null;
                try {
                    ...
                    if(unidad.unidadMedida_editar(objUnidadMedida)==true){
                        this.ListarUnidadMedida();
  ...
  public void EliminarUnidadMedida()
    {
        int respuesta=JOptionPane.showConfirmDialog(null,"¿Seguro de eliminar datos de unidad de medida?","Pregunta",JOptionPane.YES_NO_OPTION);
        if(respuesta==JOptionPane.OK_OPTION)
        {
            try
            {
                String codigo=this.txtCodigo.getText();
                if(unidad.unidadMedida_eliminar(codigo)==true){
                    this.ListarUnidadMedida();
  ...
  public void ObtenerUnidadMedida(String codigo)
    {
        UnidadMedida objUnidadMedida=null;
        try{
            objUnidadMedida=unidad.unidadMedida_obtener_por_codigo(codigo);
            if (objUnidadMedida!=null){
                this.txtCodigo.setText(objUnidadMedida.getCodigo_uni());
                this.txtNombre.setText(objUnidadMedida.getNombre_uni());
                this.txtaDescripcion.setText(objUnidadMedida.getDescripcion_uni());
    ...
    public void ListarUnidadMedida(){
        ...
        try {
            ...
            lista=unidad.unidadMedida_listar();

            DefaultTableModel modelo=(DefaultTableModel)this.JtUnidadMedida.getModel();
            while(this.JtUnidadMedida.getRowCount()>0){
                modelo.removeRow(0);
            }
            for(int i=0;i<lista.size();i++){
                objUnidadMedida=(UnidadMedida)lista.get(i);
                fila=new String[2];
                fila[0]=objUnidadMedida.getCodigo_uni();
                fila[1]=objUnidadMedida.getNombre_uni();
                modelo.addRow(fila);
            }
        ...
        try {
            if(this.JrbCodigo.isSelected())
            {
                ...
                if(codigo.compareTo("")==0){
                    lista=unidad.unidadMedida_listar_por_codigo("");
                }
                else{
                    lista=unidad.unidadMedida_listar_por_codigo(codigo);
                }
            }else if(this.JrbNombre.isSelected())
            {
                nombre=this.txtBuscar.getText().trim();
                if(nombre.compareTo("")==0){
                    lista=unidad.unidadMedida_listar_por_nombre("");
                }
                else{
                    lista=unidad.unidadMedida_listar_por_nombre(nombre);
                }
            }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(aplibodega.ApliBodegaApp.class).getContext().getResourceMap(UnidadMedida_Administrar.class);
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        String Codigo=unidad.unidadMedida_generar_codigo();
    ...
    private void JtUnidadMedidaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JtUnidadMedidaMouseClicked
        String ccodigo=(String)this.JtUnidadMedida.getValueAt(this.JtUnidadMedida.getSelectedRow(), 0);
        this.ObtenerUnidadMedida(ccodigo);
