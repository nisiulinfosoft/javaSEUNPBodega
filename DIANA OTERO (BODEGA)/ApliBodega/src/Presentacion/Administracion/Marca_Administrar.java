...
public class Marca_Administrar extends JP_Modelo {
  ...
  public void Formato_tabla(){
        ...
        this.JtMarca.getColumnModel().getColumn(1).setPreferredWidth(300);
  }
  ...
  public void RegistrarMarca()
  {
        ...
        if(vCodigo.isEmpty() || vNombre.isEmpty()){
            ...
            int respuesta=JOptionPane.showConfirmDialog(null,"¿Seguro de regístrar datos de marca?","Pregunta",JOptionPane.YES_NO_OPTION);
            if(respuesta==JOptionPane.OK_OPTION)
            {
                Marca objMarca=null;
                try {
                    objMarca=new Marca();
                    objMarca.setCodigo_mar(this.txtCodigo.getText().trim());
                    objMarca.setNombre_mar(this.txtNombre.getText().trim());
                    objMarca.setDescripcion_mar(this.txtaDescripcion.getText().trim());

                    if(marca.marca_registrar(objMarca)==true){
                        this.ListarMarca();
  ...
  public void EditarMarca()
    {
        ...
        if(vCodigo.isEmpty() || vNombre.isEmpty()){
            ...
            int respuesta=JOptionPane.showConfirmDialog(null,"¿Seguro de editar datos de marca?","Pregunta",JOptionPane.YES_NO_OPTION);
            if(respuesta==JOptionPane.OK_OPTION)
            {
                Marca objMarca=null;
                try {
                    ...
                    if(marca.marca_editar(objMarca)==true){
                        this.ListarMarca();
  ...
  public void EliminarMarca()
    {
        int respuesta=JOptionPane.showConfirmDialog(null,"¿Seguro de eliminar datos de marca?","Pregunta",JOptionPane.YES_NO_OPTION);
        if(respuesta==JOptionPane.OK_OPTION)
        {
            try
            {
                String codigo=this.txtCodigo.getText();
                if(marca.marca_eliminar(codigo)==true){
                    this.ListarMarca();
  ...
  public void ObtenerMarca(String codigo)
    {
        ...
        try{
            ...
            if (objMarca!=null){
                this.txtCodigo.setText(objMarca.getCodigo_mar());
                this.txtNombre.setText(objMarca.getNombre_mar());
                this.txtaDescripcion.setText(objMarca.getDescripcion_mar());
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(aplibodega.ApliBodegaApp.class).getContext().getResourceMap(Marca_Administrar.class);
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        String Codigo=marca.marca_generar_codigo();
