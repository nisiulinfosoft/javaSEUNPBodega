...
public class UnidadMedida_Buscar extends JP_Modelo {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(aplibodega.ApliBodegaApp.class).getContext().getResourceMap(UnidadMedida_Buscar.class);
    ...
    private void JtUnidadMedidaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JtUnidadMedidaMouseClicked
        ...
        {
            ((Producto_Administrar)this.getRefDep()).ObtenerUnidadMedida(ccodigo);
        }
        this.cerrarPadre();
