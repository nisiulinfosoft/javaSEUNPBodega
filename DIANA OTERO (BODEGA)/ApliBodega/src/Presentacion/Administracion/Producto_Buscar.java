...
public class Producto_Buscar extends JP_Modelo {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(aplibodega.ApliBodegaApp.class).getContext().getResourceMap(Producto_Buscar.class);
    ...
    private void JtProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JtProductoMouseClicked
        ...
        {
            //((GestionarVenta)this.getRefDep()).ObtenerProducto(ccodigo);
        }
        this.cerrarPadre();
